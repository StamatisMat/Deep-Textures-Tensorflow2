            ...
            for i in range(len(self.layer_loss_scores)):
                ...
                if(avg == 1):
                    if(layer_name == 'block_pool2' or layer_name == "block_pool3"):
                        loss = loss + K.variable(0.75) * self.layer_losses[i][layer_name]
                    elif (layer_name == 'block_pool1'):
                        loss = loss + K.variable(1.2) * self.layer_losses[i][layer_name]
                    elif (layer_name == 'block_pool5'):
                        loss = loss + K.variable(0.9) * self.layer_losses[i][layer_name]
                    else:
                        loss = loss + self.layer_losses[i][layer_name]
            #print("Min Index for layer %s is %d"%(layer_name,minIndex))
            if (avg == 0):
                if(layer_name == 'block_pool2' or layer_name == "block_pool3"):
                    loss = loss + K.variable(0.75) * self.layer_losses[minIndex][layer_name]
                elif (layer_name == 'block_pool1'):                
                    loss = loss + K.variable(1.2) * self.layer_losses[i][layer_name]
                elif (layer_name == 'block_pool5'):
                    loss = loss + K.variable(0.9) * self.layer_losses[i][layer_name]
...
if __name__ == "__main__":
    # Sample run.
    tex_list = ['data/inputs/ruins1/tex_ruins1.png','data/inputs/ruins1/tex_ruins3.png','data/inputs/ruins1/tex_ruins4.png','data/inputs/ruins4/tex_ruins4.png','data/inputs/ruins4/tex_ruins5.png','data/inputs/ruins4/tex_ruins6.png','data/inputs/ruins4/tex_ruinss.png','data/inputs/ruins4/tex_ruinss3.png','data/inputs/ruins4/tex_ruinss4.png']
    base_img ='data/inputs/ruins4/base_ruinss22.png'
    #tex_list = ['data/inputs/ruins3/tex_ruins1.png','data/inputs/ruins3/tex_ruins4.png','data/inputs/ruins3/tex_ruins6.png','data/inputs/ruins3/tex_ruinss.png','data/inputs/ruins3/tex_ruinss2.png','data/inputs/ruins3/tex_ruinss3.png','data/inputs/ruins3/tex_ruinss4.png']
    #base_img = 'data/inputs/ruins3/base_ruins3.png'
    tex = DeepTexture('tex55',tex_list,base_img_path=base_img)
    #tex_list = ['data/inputs/pebbles3/pebbles1.png','data/inputs/pebbles3/pebbles3.png']
    #base_img = 'data/inputs/pebbles3/pebbles_base.png'
    #tex = DeepTexture('tex1',tex_list)
    tex.buildFunctions(features='all')
    #count = 1
    tex.UpdateTex(avg = 0)
    tex.runIterations(iterations = 10000 ,printInterval = 50,save=200,update = 1)
